...
const DATA_MANAGEMENT_LINKS = [
  { 
    href: '/settings/data-management/import',         
    label: 'Import Alumni Data',   
    description: 'Upload CSV or XLSX exports from GHAR and configure schema mappings.',
    icon: FileUp,
    badge: 'Super Admin',
  ...
  { 
    href: '/settings/data-management/import-history', 
  ...
  { 
    href: '/settings/data-management/audit-logs',     
    label: 'Audit Logs',           
  ...
  { 
    href: '/settings/data-management/record-history', 
  ...
  { 
    href: '/settings/data-management/rollback',       
            ...
            <Link key={link.href} href={link.href} className="group block">
              <Card className={`h-full border border-border/80 bg-card/60 backdrop-blur-sm transition-all duration-300 relative overflow-hidden group-hover:-translate-y-1 group-hover:shadow-lg ${link.border}`}>
                ...
                <CardHeader className="flex flex-row items-start gap-4 space-y-0 relative z-10">
                  <div className={`p-3.5 rounded-xl transition-all duration-300 ${link.iconBg} shadow-sm group-hover:scale-105 group-hover:rotate-3`}>
