...
export function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center bg-transparent py-4 transition-all duration-500">
      <div className="w-full max-w-[360px] bg-white dark:bg-slate-900 rounded-md shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-500">
        <Toaster />
        <div className="p-7 md:p-8">
          ...
          {error && (
            <div className="mb-5 p-3.5 bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/50 rounded-md flex items-start gap-2.5 animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <div className="space-y-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 py-3 rounded-md font-bold text-slate-700 dark:text-slate-200 hover:border-indigo-500 dark:hover:border-indigo-500 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-all active:scale-[0.98] disabled:opacity-50 shadow-md hover:shadow-lg shadow-slate-200/50 dark:shadow-none"
            >
              {isSocialLoading ? (
